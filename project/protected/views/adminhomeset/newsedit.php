<div class="pageContent">
    <form method="post" action="<?php echo Yii::app()->createAbsoluteUrl('adminhomeset/newsupdate'); ?>" class="pageForm required-validate" onsubmit="return iframeCallback(this, viData);" enctype="multipart/form-data">
        <div class="pageFormContent" layoutH="56">
            ...
            <p class="nowrap">
                <label>链接：</label>
                <input  name="news_link" type="text" class="textInput required" size="50" value="<?php echo $models->link;?>">
            </p>
            <p>
                <label>内容：</label>
                <textarea name="news_content" cols="35" rows="6"><?php echo $models->content;?></textarea>
            </p>
        </div>
        <div class="formBar">
            <ul>
